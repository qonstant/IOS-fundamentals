...
//print("The value of foo is \(foo)")
print("Since terminal can't recognize the variable. Its private variable inside of the loop")
...
print("In this code it worked out, since here we have globally declared variable")
