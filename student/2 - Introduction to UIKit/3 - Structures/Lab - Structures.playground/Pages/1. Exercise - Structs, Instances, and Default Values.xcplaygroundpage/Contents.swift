...
favoriteBook.title = "Cashflow Quadrant"
favoriteBook.author = "Robert Kiyosaki"
favoriteBook.pages = 322
favoriteBook.price = 13

print("\"\(favoriteBook.title)\" by \(favoriteBook.author) costs \(favoriteBook.price) dollars")
/*:
