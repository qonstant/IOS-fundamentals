...
var yourName = User(username: "nagibator667", age: 20, height: 170, weight: 60.5, activityLevel: 7)
print("\(yourName.username), \(yourName.age) years old, height :\(yourName.height) cm \n weight: \(yourName.weight) kg \n activity level :\(yourName.activityLevel)")
/*:
