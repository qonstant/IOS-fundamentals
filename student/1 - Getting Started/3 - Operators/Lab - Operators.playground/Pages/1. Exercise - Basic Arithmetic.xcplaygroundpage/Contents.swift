...
print("double10 value is: \(double10)\n double3 value is \(double3)")
/*:
...
// This function defines either number is even or odd

typeOfNumber(number: even)

typeOfNumber(number: odd)
/*:
