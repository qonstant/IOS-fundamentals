 ...
 */
let heartRate1 = Int.random(in: 60..<100)
let heartRate2 = Int.random(in: 60..<100)
let heartRate3 = Int.random(in: 60..<100)

let averageHR :Float = Float(heartRate1 + heartRate2 + heartRate3) / 3
print(averageHR)
...
let addedHRD :Double = heartRate2D + heartRate2D + heartRate3D
